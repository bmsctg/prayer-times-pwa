...
// ── 30-Day Mobile-Friendly Prayer Schedule PDF Exporter ────────────────────
async function download30DaySchedule() {
  ...
  if (statusEl) statusEl.textContent = 'Generating 30-day prayer timetable PDF...';
...
function init() {
  ...
  if (downloadPdfBtn) downloadPdfBtn.addEventListener('click', () => download30DaySchedule());
